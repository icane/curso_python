		...
		methods = {
			...
			_addNextPrev: function(){
				...
				$nav = $("<nav class='"+ navClass +"'>" +
					"<a href='#prev' class='prev' aria-hidden='true' title='Anterior'>Anterior</a>" +
					"<a href='#next' class='next' aria-hidden='true' title='Siguiente'>Siguiente</a>" +
					"</nav>");
